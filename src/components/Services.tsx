...
function ServiceCard({ icon, title, description }: ServiceCardProps) {
  return (
    <div className="bg-white drop-shadow-[0px_8px_8px_rgba(0,0,0,0.02)] relative rounded-[12px] border border-[#e9ecef] flex-1 min-w-[260px] hover:shadow-md transition-shadow">
      <div className="flex flex-col gap-5 items-start p-8 h-full">
        <div className="bg-[rgba(17,19,21,0.08)] flex items-center justify-center rounded-[8px] size-[44px] shrink-0">
          {icon}
        </div>
        <div className="flex flex-col gap-[10px]">
          <h3 className="font-['Unbounded:Bold',sans-serif] font-bold text-[#111315] text-[16px] leading-normal">{title}</h3>
          <p className="font-['Inter:Regular',sans-serif] font-normal text-[#6c757d] text-[14px] leading-[1.5]">{description}</p>
        </div>
      </div>
    </div>
  );
...
function BuildingIcon() {
  return (
    <svg className="size-[28px]" fill="none" height="28" viewBox="0 0 28 28" width="28">
      <path d={svgPaths.p21a55c40} stroke="#111315" strokeLinecap="round" strokeWidth="2" />
    </svg>
  );
}
...
function WrenchIcon() {
  return (
    <svg className="size-[28px]" fill="none" height="28" viewBox="0 0 28 28" width="28">
      <path d={svgPaths.p3ee14400} stroke="#111315" strokeLinecap="round" strokeWidth="2" />
    </svg>
  );
}
...
function MaximizeIcon() {
  return (
    <svg className="size-[28px]" fill="none" height="28" viewBox="0 0 28 28" width="28">
      <path d={svgPaths.p2b2a380} stroke="#111315" strokeLinecap="round" strokeWidth="2" />
    </svg>
  );
}
...
function DropletOffIcon() {
  return (
    <svg className="size-[28px]" fill="none" height="28" viewBox="0 0 28 28" width="28">
      <path d={svgPaths.p220e9980} stroke="#111315" strokeLinecap="round" strokeWidth="2" />
    </svg>
  );
}
...
function GridIcon() {
  return (
    <svg className="size-[28px]" fill="none" height="28" viewBox="0 0 28 28" width="28">
      <path d={svgPaths.pa5f0880} stroke="#111315" strokeLinecap="round" strokeWidth="2" />
    </svg>
  );
}
...
function FileSignatureIcon() {
  return (
    <svg className="size-[28px]" fill="none" height="28" viewBox="0 0 28 28" width="28">
      <path d={svgPaths.p26218c80} stroke="#111315" strokeLinecap="round" strokeWidth="2" />
    </svg>
  );
}
...
export default function Services() {
  return (
    <section id="servicios" className="bg-[#f8f9fa] w-full py-[60px] px-5 md:px-[80px]">
      {/* Section header */}
      <div className="flex flex-col gap-3 items-center text-center mb-[60px]">
        <p className="font-['Unbounded:Bold',sans-serif] font-bold text-[#1a1d20] text-[12px] uppercase tracking-wide">Especialistas a tu disposición</p>
        <h2 className="font-['Unbounded:ExtraBold',sans-serif] font-extrabold text-[#111315] text-[clamp(28px,4vw,36px)] leading-[1.2]">Nuestros Servicios</h2>
        <p className="font-['Inter:Regular',sans-serif] font-normal text-[#6c757d] text-[16px] leading-[1.5] max-w-[720px]">
